...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            private global::System.Data.DataColumn columnItem_serial_no;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn Item_serial_noColumn {
                get {
                    return this.columnItem_serial_no;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public InventoryRow AddInventoryRow(string Item_name, string Item_Quantity, string Item_serial_no) {
            ...
            internal void InitVars() {
                ...
                this.columnItem_serial_no = base.Columns["Item_serial_no"];
            }
            ...
            private void InitClass() {
                ...
                this.columnItem_serial_no = new global::System.Data.DataColumn("Item_serial_no", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnItem_serial_no);
                ...
                this.columnItem_serial_no.AllowDBNull = false;
                this.columnItem_serial_no.MaxLength = 50;
            }
        ...
        public partial class InventoryRow : global::System.Data.DataRow {
            ...
            public string Item_Quantity {
                get {
                    return ((string)(this[this.tableInventory.Item_QuantityColumn]));
                }
                set {
            ...
            public string Item_serial_no {
                get {
                    return ((string)(this[this.tableInventory.Item_serial_noColumn]));
                }
                set {
                    this[this.tableInventory.Item_serial_noColumn] = value;
                }
            }
        }
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([Id] = @Original_Id) AND ([Item_name] = @Or" +
                "iginal_Item_name) AND ([Item_Quantity] = @Original_Item_Quantity) AND ([Item_ser" +
                "ial_no] = @Original_Item_serial_no))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Item_Quantity", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_Quantity", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Item_serial_no", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_serial_no", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([Id], [Item_name], [Item_Quantity], [Item_serial_n" +
                "o]) VALUES (@Id, @Item_name, @Item_Quantity, @Item_serial_no);\r\nSELECT Id, Item_" +
                "name, Item_Quantity, Item_serial_no FROM Inventory WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Item_Quantity", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_Quantity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Item_serial_no", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_serial_no", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [Id] = @Id, [Item_name] = @Item_name, [Item_Quantity] = @Item_Quantity, [Item_serial_no] = @Item_serial_no WHERE (([Id] = @Original_Id) AND ([Item_name] = @Original_Item_name) AND ([Item_Quantity] = @Original_Item_Quantity) AND ([Item_serial_no] = @Original_Item_serial_no));
SELECT Id, Item_name, Item_Quantity, Item_serial_no FROM Inventory WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Item_Quantity", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_Quantity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Item_serial_no", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_serial_no", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Item_Quantity", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_Quantity", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Item_serial_no", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Item_serial_no", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Item_name, Item_Quantity, Item_serial_no FROM dbo.Inventory";
        ...
        public virtual int Delete(int Original_Id, string Original_Item_name, string Original_Item_Quantity, string Original_Item_serial_no) {
            ...
            if ((Original_Item_Quantity == null)) {
                throw new global::System.ArgumentNullException("Original_Item_Quantity");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_Item_Quantity));
            }
            if ((Original_Item_serial_no == null)) {
                throw new global::System.ArgumentNullException("Original_Item_serial_no");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Item_serial_no));
            }
        ...
        public virtual int Insert(int Id, string Item_name, string Item_Quantity, string Item_serial_no) {
            ...
            if ((Item_Quantity == null)) {
                throw new global::System.ArgumentNullException("Item_Quantity");
            }
            else {
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(Item_Quantity));
            }
            if ((Item_serial_no == null)) {
                throw new global::System.ArgumentNullException("Item_serial_no");
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Item_serial_no));
            }
        ...
        public virtual int Update(int Id, string Item_name, string Item_Quantity, string Item_serial_no, int Original_Id, string Original_Item_name, string Original_Item_Quantity, string Original_Item_serial_no) {
            ...
            if ((Item_Quantity == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Item_Quantity));
            }
            if ((Item_serial_no == null)) {
                throw new global::System.ArgumentNullException("Item_serial_no");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Item_serial_no));
            }
            ...
            if ((Original_Item_Quantity == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Item_Quantity));
            }
            if ((Original_Item_serial_no == null)) {
                throw new global::System.ArgumentNullException("Original_Item_serial_no");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Item_serial_no));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item_name, string Item_Quantity, string Item_serial_no, int Original_Id, string Original_Item_name, string Original_Item_Quantity, string Original_Item_serial_no) {
            return this.Update(Original_Id, Item_name, Item_Quantity, Item_serial_no, Original_Id, Original_Item_name, Original_Item_Quantity, Original_Item_serial_no);
        }
    }
